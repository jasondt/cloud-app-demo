package net.jasondt.web.rest;

import net.jasondt.CloudAppDemoApp;
import net.jasondt.domain.Authority;
...
import net.jasondt.security.AuthoritiesConstants;

import net.jasondt.service.UserService;
import net.jasondt.service.dto.UserDTO;
import net.jasondt.service.mapper.UserMapper;
import net.jasondt.web.rest.errors.ExceptionTranslator;
